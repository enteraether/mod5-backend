...
goal1 = Goal.create(likes: 1, private: true, what: 'read 15 mins / day', why: 'learn more', name: 'Reading Goal', start_date: '30/3/2020', user_id: 1 )
goal2 = Goal.create(likes: 200, private: false, what: 'study french 15 mins / day', why: 'speak french w my frands', name: 'French Goal', start_date: '1/4/2020', user_id: 1 )
...
goal4 = Goal.create(likes: 76, private: false, what: 'study machine learning algorothms 30 mins/day ', why: 'so i can build awesome things w it', name: 'Code Awesome Sh%t', start_date: '3/4/2020', user_id: 2 )
